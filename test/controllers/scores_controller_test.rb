...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { event_id: @score.event_id, player_id: @score.player_id, points: @score.points } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { event_id: @score.event_id, player_id: @score.player_id, points: @score.points } }
